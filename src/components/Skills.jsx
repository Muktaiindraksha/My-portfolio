...
const skills = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: "Python", icon: <SiPython className="text-gray-500" /> },
...
const Skills = () => {
  return (
    <div
      className="max-w-[600px] mx-auto flex flex-col justify-center px-4 text-gray-200 pb-8 md:py-12"
      id="about"
    >
      <Reveal>
        ...
        <p className="mb-8 text-center">
          ...
          <a href="https://github.com/Muktaiindraksha" className="underline">
            Here.
          </a>
